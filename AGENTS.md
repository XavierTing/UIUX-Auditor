...
This project includes a Codex skill for running audits:

- **`/ux-audit [url]`** — Run a full 9-dimension UI/UX audit on any product. Located at `.Codex/skills/ux-audit/`. See the [SKILL.md](.Codex/skills/ux-audit/SKILL.md) for full details.
...
```
├── AGENTS.md              # This file — audit methodology & agent instructions
├── .Codex/skills/ux-audit/
